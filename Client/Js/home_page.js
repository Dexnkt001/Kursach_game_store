...
function main_list_recommended_games(arr) {
  ...
  let new_games_html = `
  <div class="items-rec-games">

      <img class="click_img" src="${arr[0].images.main_img}" alt="${arr[0].name}">
      <div class="new-game-name">${arr[0].name}</div>
      <div class="new-game-developer ">${arr[0].developer}</div>
      <div class="new-game-prise">${arr[0].prize} &#8381;</div>
    </div>
    <div class="items-rec-games">

    <img class="click_img" src="${arr[1].images.main_img}" alt="${arr[1].name}">
    <div class="new-game-name">${arr[1].name}</div>
    <div class="new-game-developer ">${arr[1].developer}</div>
    <div class="new-game-prise">${arr[1].prize} &#8381;</div>
    </div>
    <div class="items-rec-games">

    <img class="click_img" src="${arr[2].images.main_img}" alt="${arr[2].name}">
    <div class="new-game-name">${arr[2].name}</div>
    <div class="new-game-developer ">${arr[2].developer}</div>
    <div class="new-game-prise">${arr[2].prize} &#8381;</div>
    </div>
    <div class="items-rec-games">

    <img class="click_img" src="${arr[3].images.main_img}" alt="${arr[3].name}">
    <div class="new-game-name">${arr[3].name}</div>
    <div class="new-game-developer ">${arr[3].developer}</div>
    <div class="new-game-prise">${arr[3].prize} &#8381;</div>
    </div>
    <div class="items-rec-games">

    <img class="click_img" src="${arr[4].images.main_img}" alt="${arr[4].name}">
    <div class="new-game-name">${arr[4].name}</div>
    <div class="new-game-developer ">${arr[4].developer}</div>
    <div class="new-game-prise">${arr[4].prize} &#8381;</div>
    </div>
  `;
  document
